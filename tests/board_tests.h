...
public:
    ...
    void testEmpty()
    {
        ...
        b.add(0, card("test", 1, 2, 3, false, false, false));
    ...
    void testAddCard()
    {
        ...
        brd->add(0, card("a", 1, 1, 1, false, false, false));
        brd->add(1, card("a", 1, 1, 1, false, false, false));
        brd->add(1, card("a", 1, 1, 1, false, false, false));
    ...
    void testCardLists()
    {
        ...
        brd->add(0, card("a_card", 1, 1, 1, false, false, false));
        brd->add(0, card("a_card", 1, 1, 1, false, false, false));
        brd->add(1, card("b_card", 2, 2, 2, false, false, false));
    ...
    void testCardTaunt()
    {
        ...
        brd->add(0, card("a_card", 3, 3, 3, false, false, false));
        brd->add(1, card("b_card", 1, 1, 1, true, false, false));
        brd->add(1, card("b_card", 2, 2, 2, false, false, false));
    ...
    void testCardRemove()
    {
        ...
        brd->add(0, card("a_card", 1, 1, 1, false, false, false));
        brd->add(1, card("b_card", 1, 1, 1, false, false, false));
